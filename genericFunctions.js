...
function keyToCode (key) {
    var code = key;
    if (key == 'up') code = 38;
	else if (key == 'down') code = 40;
	else if (key == 'left') code = 37;
	else if (key == 'right') code = 39;
	else if (key == 'w') code = 87;
	else if (key == 's') code = 83;
	else if (key == 'a') code = 65;
	else if (key == 'd') code = 68;
	else if (key == 'z') code = 90;
	else if (key == 'x') code = 88;
    else if (key == 'f') code = 70;
    else if (key == 'g') code = 71;
    else if (key == 'h') code = 72;
    else if (key == 'j') code = 74;
    return code;
}

function keyIsDown (key) {
	return keyToCode (key) in keysDown;
}
